...
from lavis.models.blip2_models.blip2 import Blip2Base, disabled_train, memory_bank_compress, apply_memory_bank
from lavis.models.blip2_models.Qformer import BertConfig, BertLMHeadModel, BertSelfAttention, BertAttention, BertLayer, BertModel, BertEncoder, MoEBertModel, MoEBertLMHeadModel
...
@registry.register_model("moe_blip2_vicuna_instruct_malmm")
class MoEBlip2VicunaInstruct_MALMM(Blip2VicunaInstruct_MALMM):
    def __init__(
        self,
        vit_model="eva_clip_g",
        img_size=224,
        ...
        super(MoEBlip2VicunaInstruct_MALMM, self).__init__(
            vit_model=vit_model, 
            img_size=img_size, 
            drop_path_rate=drop_path_rate, 
            use_grad_checkpoint=use_grad_checkpoint, 
    ...
    def init_Qformer(cls, num_query_token, vision_width, cross_attention_freq=2, memory_bank_length=0, num_frames=0):
        ...
        Qformer = MoEBertLMHeadModel.from_pretrained(
